...
Usage:
    python -m scripts.finetune.merge_grpo_lora \\
        ...
        --adapter weights/intros_grpo_llama_v1/meta-llama__Llama-3.1-8B-Instruct/epoch1 \\
        --out    weights/intros_grpo_llama_v1/meta-llama__Llama-3.1-8B-Instruct/merged
"""
import argparse
import time
...
def main():
    """Merge the --adapter LoRA into --base and save the standalone checkpoint to --out.

    Skip the merge if --out is already populated.
    """
