...
Strategy:
  ...
  - Balanced 1500 YES + 1500 NO across the v2 labels
...
def parse(fname):
    """Parse a judged filename into adv/model/dataset, or None if it does not match."""
...
def stratified_sample(buckets, target):
    """Draw up to target items evenly across buckets, filling any shortfall at random."""
...
def truncate_for_judge(entry):
    """Clean and truncate an entry's followup_response exactly as the judge sees it."""
