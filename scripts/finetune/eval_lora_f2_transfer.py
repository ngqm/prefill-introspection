...
response?"). Generates with the LoRA, writes outputs ready for the v3 F2
RoBERTa classifier.
...
def main():
    """Generate the LoRA's F2 answers (F1 swapped for the tampering question) and write them."""
